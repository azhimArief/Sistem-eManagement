        ...
        <div class="row">
		  ...
		  @if (session('status'))
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
				<dl class="row">
					...
					<dd class="col-sm-9">{{ ($user->status_akaun!='') ? \App\LkpStatus::find($user->status_akaun)->status : '' }}</dd>
			...
			<div class="card-footer">
			  <a href="{{ url('pengguna/kemaskini/'.$user->id) }}" class="btn btn-info bg-purple">Kemaskini</a>
