...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" defer crossorigin="anonymous">
    </script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.4.0/locale/ms.js" defer></script>
...
<body class="reponsive">
    ...
    <div class="row mb-12">
        <div class="col-sm-12">
            @if (!Request::is('/'))
                <div class="image">
                    <center><img src="{{ asset('dist/img/JataNegara.png') }}" width="70" height="50"
                            alt="User Image"></center>
                    <center>
                        <font color="#191975">
                            <h7><b>KEMENTERIAN PERPADUAN NEGARA</b></h7>
                        </font>
                    </center><BR>
                </div>
            ...
            <center>
                <font color="black">
                    <h1><b>SISTEM eTEMPAHAN</b></h1>
                </font>
            </center>
            <center>
                <h5 class="m-0">SISTEM TEMPAHAN BILIK MESYUARAT / KENDERAAN JABATAN</h5>
            </center>
