		  ...
		  @if (session('status'))
			...
			<div class="card-body">
				...
				<dl class="row">
					...
					<dd  class="col-sm-10">
						<table id="example1" class="table table-bordered table-sm" style="width:120%">
			...
			<div class="card-header bg-purple">
				...
				<!-- if user Penyelia -->
				@if (Auth::user()->id_access == '1'  || Auth::user()->id_access == '4' && $permohonanKenderaan->id_status !== 4 && $permohonanKenderaan->id_status !== 11) 
