							...
							<div class="input-group col-sm-4">
								<select class="form-control select2" id="kenderaan_pergi" name="kenderaan_pergi" style="width: 100%;">
									...
									@foreach ($kenderaan as $optKenderaan)
										<option value="{{ $optKenderaan->id_kenderaan }}" @if(old('kenderaan_pergi')==$optKenderaan->id_kenderaan) {{ 'selected="selected"' }} @endif>{{ $optKenderaan->no_plat }}</option>
									@endforeach
								</select> 
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="input-group col-sm-4">
								<select class="form-control select2" id="kenderaan_balik" name="kenderaan_balik" style="width: 100%;">
									<option value="" @if(old('kenderaan_pergi')=='') {{ 'selected="selected"' }} @endif>&nbsp;</option>
									@foreach ($kenderaan as $optKenderaan)
										<option value="{{ $optKenderaan->id_kenderaan }}" @if(old('kenderaan_balik')==$optKenderaan->id_kenderaan) {{ 'selected="selected"' }} @endif>{{ $optKenderaan->no_plat }}</option>
									@endforeach
								</select> 
							</div>
						</div>
