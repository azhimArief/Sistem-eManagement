                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php
                      ...
                      switch($status){
                        //permohonan baru
                        case "1": $color="#FFB300"; if (Auth()->user()->id_access == 1) { $status="Permohonan Baru"; } else{ $status="Dalam Proses"; } break; //kuning
                        //telah dikemaskini
                        case "2": $color="#FFB300"; if (Auth()->user()->id_access == 1) { $status="Dikemaskini"; } else{ $status="Dalam Proses"; } break; //biru
                        //lulus
