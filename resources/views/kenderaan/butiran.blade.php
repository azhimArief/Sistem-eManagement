...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">BUTIRAN KENDERAAN</h1>
          </div><!-- /.col -->
            ...
            <div class="card card-info">
              ...
              <dl class="row">
                ...
                <div class="card-footer">
                  <a href="{{ url('kenderaan/kemaskini/'.$kenderaan->id_kenderaan) }}" class="btn btn-info bg-purple">Kemaskini</a>
                  <a href="{{ url('kenderaan/hapus/'.$kenderaan->id_kenderaan) }}" class="btn btn-danger">Hapus</a>
