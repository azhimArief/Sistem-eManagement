...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">BATAL TEMPAHAN</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
		  ...
		  @if (session('status'))
			...
			@endif
			 ...
			 <form class="form-horizontal" method="POST" action="{{ url('tempahanbilik/batal/'.$permohonanBilik->id_permohonan_bilik) }}" enctype="multipart/form-data">
			 {{ csrf_field() }}
			...
			<div class="card-body">
				<dl class="row">
					...
					<dt class="col-sm-10"> <br>Senarai Tempahan Makanan</dt>
						...
						<dt class="col-sm-12"><br>Harga Tempahan Makanan : RM {{ $tempahMakans->kadar_harga ?? "-"}} <br></dt>
					@else		
					@endif
