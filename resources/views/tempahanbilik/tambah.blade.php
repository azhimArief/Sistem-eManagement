                ...
                <form role="form" action="{{ route('tempahanbilik.simpan_tambah', $result->nokp) }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="nama" class="col-sm-3" style="text-align:left">Cari Nama Pegawai </label>
                            <div class="input-group col-sm-6 ">
                                {{-- <input type="text" class="form-control" id="nama" name="nama"
                                    value="{{ $result->name }}" readonly> --}}
                                    <select class="form-control select2" id="Carinama" name="Carinama" style="width: 100%;" >
                                        <option value=""
                                            @if (old('nama') == '') {{ 'selected="selected"' }} @endif>&nbsp;</option>
                                        @foreach ($personels as $personel)
                                            <option value="{{ $personel->id }}"
                                                @if (old('nama') == $personel->id) {{ 'selected="selected"' }} @endif>
                                                {{ $personel->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="input-group-append">
								<button type="submit" id="cari_nama" name="cari_nama" value="" class="input-group-text" value="ignore" formnovalidate><i class="fa fa-search"></i> </button>
							</div>
                        </div>

                        <div class="form-group row">
                            <label for="nama" class="col-sm-3 col-form-label" style="text-align:left">Nama Pemohon </label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama" name="nama"
                                    ...
                                    <input type="hidden" name="nokp" value="{{ old('nokp') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="bahagian" name="bahagian"
                                    ...
                                    {{-- readonly="readonly" --}}
                                    >
                                    {{-- <select class="custom-select" id="bahagian" name="bahagian">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="emel" name="emel" placeholder="E-mel" value="{{ old('emel') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="telefon" name="telefon" placeholder="No. Tel. Pejabat" value="{{ old('telefon') }}" required>
                            </div>

                            <label for="tel_bimbit" class="col-sm-3 col-form-label" style="text-align:left">No. Telefon Bimbit <font color= "red">*</font>  </label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="tel_bimbit" name="tel_bimbit" placeholder="No. Tel Bimbit" value="{{ old('tel_bimbit') }}" >
                            </div>
                        </div>
                    ...
                    <div class="card-footer justify-content-center">
                        @if (!isset($tindakan))
                            ...
                            <button type="submit" id="tempahMakan"
                                    ...
                                    Seterusnya</button>
                            <font color="red" class="float-left">&nbsp; <italic> (Maklum: Tempahan akan dihantar selepas tekan butang Hantar/Seterusnya.)</italic></font>
                        @endif
...
<script>
    ...
    //     foreach ($personels as $personel)
    //         if ($personel->id == nama)
    //             document.getElementById("bahagian").value = $personels->jawatan;
    ...
    //script for select bilik tapis
        $(document).ready(function(){
            $(document).on('change','#nama',function(){
                ...
                $.ajax({
                    type:'get',
                    url:'{!!URL::to('searchPegawais')!!}',
                    data:{'nama':nama},
                    success:function(data){
                    console.log(data);
                    //op+='<option value="" selected disabled>-- Pilih Bahagian--</option>';
                    //for(var i=0;i<data.length;i++){
                        op+='<option value="'+data[i].id+'">'+data[i].name+'</option>';
                        // op+='<input type='text' class='form-control' id='bahagian' name='bahagian'
                        //             value="' +data[i].name+ ' "  ';
                   // }
                    div.find('#bahagian').html(" ");
                    div.find('#bahagian').append(op);
                    },
                    error:function(){
                    }
                });
