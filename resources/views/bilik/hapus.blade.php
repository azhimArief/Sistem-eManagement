        ...
        <div class="row">
		  ...
		  @if (session('status'))
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			  <form class="form-horizontal" method="POST" action="{{ url('bilik/hapus/'.$biliks->id_bilik) }}" enctype="multipart/form-data">
			       {{ csrf_field() }}
              <div class="card-body">
                <dl class="row">
                ...
                <div class="card-footer">
				          <span class="text-danger">Anda pasti ingin hapuskan maklumat bilik ini?</span> &nbsp;
                  <button type="submit" name="hapus_bilik" class="btn btn-danger">Ya, Hapus</button>
