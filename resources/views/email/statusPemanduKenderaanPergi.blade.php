...
<head>
    <title>Emel kepada Pemandu</title>
</head>
<body>
    ...
    <justify>
    <p>2. &emsp;&emsp;Adalah dimaklumkan tuan ditugaskan untuk memandu Kenderaan Jabatan Kementerian Perpaduan Negara seperti berikut:</p>
    ...
    <p> 
        <table width="650" border="0" style="border-collapse:collapse;  font-size:13px; text-align:left; margin:0px 0px 0px 40px;" cellpadding="3" >
            <tr>
                ...
                <td width="500"><strong>: {{ $content->kod_permohonan }}</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><strong>: KPN&rarr;{{ $content->lokasi_tujuan }}, {{ \App\RLkpNegeri::find($content->id_negeri)->negeri }}</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>: @foreach($penumpangs as $penumpang)
                        <strong>{{ $penumpang->nama }} </strong>(Tel.: {{ $penumpang->no_tel }})<br>&nbsp;
                                @endforeach
                </td>
            </tr>
        </table>
    ...
    <!-- <p>Status tempahan Kenderaan Jabatan juga boleh disemak melalui <a href="devaplikasi.perpaduan.gov.my/mybooking">Sistem eManagement</a>. -->
