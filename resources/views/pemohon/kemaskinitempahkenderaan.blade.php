...
<!-- <div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-12">
				<button type="button" class="btn btn-info btn-block bg-purple"><h5>KEMASKINI TEMPAHAN KENDERAAN</h5></button>
			</div>
		</div>
	</div>
</div> -->
...
<div class="container"  align="center">
	...
	<div class="col-sm-11">
		<div class="row mb-2">
			<div class="col-sm-12">
				<button type="button" class="btn btn-light btn-block bg-purple"><h5>KEMASKINI TEMPAHAN KENDERAAN</h5></button>
			</div>
			<!-- /.col -->
		</div><!-- /.row -->
	</div>
	...
	<div class="col-sm-11">
		...
		<div class="card card-info">
			...
			<!-- /.card-header -->
			<form class="form-horizontal"  method="POST" action="{{ url('pemohon/tempahankenderaan/kemaskini/simpan/'.$permohonanKenderaan->id_maklumat_permohonan) }}" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="card-body"  style="text-align:left" >
				<div class="form-group row">
					<label for="bil_penumpang" class="col-sm-2 col-form-label">Bil. Penumpang : <font color= "red">*</font> <small><i>  (Bilangan penumpang <b>termasuk</b> pemohon.)  </i></small></label>
					<div class="col-sm-3">
				...
				<div class="form-group row">
					<label for="senarai_penumpang" class="col-sm-7 col-form-label">Senarai Penumpang : 	<br><small><i> (Masukkan maklumat penumpang <b>termasuk</b> pemohon sekiranya pemohon juga akan menaiki kenderaan.) </i></small></label>
					<div class="col-sm-4">
				...
				<table id="example1" class="table table-bordered table-striped table-sm table-responsive-sm"  style="width:100%; ">
			...
			<div class="card-body"  style="text-align:left" >
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<div class="input-group date" id="tkh_pergi" data-target-input="nearest" placeholder="Tarikh Pergi">
							<input type="text" id="tkh_pergi" name="tkh_pergi" class="form-control datetimepicker-input" data-target="#tkh_pergi" value="{{ $permohonanKenderaan->tkh_pergi == NULL ? old('tkh_pergi') : Carbon\Carbon::parse($permohonanKenderaan->tkh_pergi)->format('d.m.Y') }}" @if($permohonanKenderaan->id_jenis_perjalanan == 4)  disabled="disabled" @endif/>
					...
					<div class="col-sm-4">
						<div class='input-group date'>
							<input type='time' class="form-control" id="masa_pergi" name="masa_pergi" value="{{ $permohonanKenderaan->masa_pergi == NULL ? old('masa_pergi') : Carbon\Carbon::parse($permohonanKenderaan->masa_pergi)->format('H:i') }}" @if($permohonanKenderaan->id_jenis_perjalanan == 4) readonly="readonly" @endif>
				...
				<div class="form-group row">
					<label for="lampiran" class="col-sm-2 col-form-label">Lampiran  <br><small><i> (Maksimum saiz 1MB)  </i></small> </label>
					<div class="col-sm-10">
						<div class="input-group">
							@if($permohonanKenderaan->lampiran!='')
							<div class="input-group-append">
								<a href="{{ url(''.$permohonanKenderaan->lampiran) }}" class="input-group-text" target="_blank"><i class="fa fa-paperclip"></i></a>
							</div>
							@endif
							<!-- <div class="input-group"> -->
							<div class="custom-file">
								<input type="file" id="lampiran" name="lampiran" class="custom-file-input" >
								<label for="exampleInputFile" class="custom-file-label" ><i>{{ ($permohonanKenderaan->lampiran!='') ? $permohonanKenderaan->lampiran : 'Sila kepilkan lampiran (Jika ada).' }}</i></label>
							</div><!-- /.input group -->
							<!-- </div> -->
			...
			<div class="card-footer">
				<button type="submit" name="submit_pengguna" class="btn btn-info btn-sm bg-purple float-left"><i class="fa fa-save"></i> | Simpan</button>
				<button type="button" class="btn btn-default btn-sm float-right" onclick="history.back();"><i class="fas fa-redo-alt"></i> | Kembali</button>
			</div>
			<!-- /.card-footer -->
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-between">
				...
				<button type="button" class="btn btn-info bg-purple" id="tambah_penumpang" onclick="tambahPenumpang()" data-dismiss="modal">Tambah</button>
			</div>
