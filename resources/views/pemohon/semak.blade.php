          ...
          <div class="card card-info">
            ...
            <div class="card-body">
                <div class="form-group row">
                  ...
                  <dd class="col-sm-10">{{ $personel->name }}</dd>
                ...
                <div class="form-group row">
                  ...
                  <dd class="col-sm-4">{{ $personel->jawatan }}</dd>
                  {{-- <dd class="col-sm-4">{{ $pemohon->jawatan }}</dd> --}}
                  <dt class="col-sm-2">Gred</dt>
                  <dd class="col-sm-4">{{ $personel->gred }}</dd>
                  {{-- <dd class="col-sm-4">{{ $pemohon->gred }}</dd> --}}
                </div>
                <div class="form-group row">
                  <dt class="col-sm-2">Bahagian</dt>
                  <dd class="col-sm-4"> {{ optional(\App\PLkpBahagian::find($personel->bahagian_id))->bahagian ?? '-' }}</dd>
                  {{-- <dd class="col-sm-4"> {{ !empty($pemohon->bahagian) ? $pemohon->bahagian : optional($personel->bahagian_id)->bahagian }}</dd> --}}
                  <dt class="col-sm-2">E-mel</dt>
                  <dd class="col-sm-4">{{ $personel->email }}</dd>
                  {{-- <dd class="col-sm-4">{{ ($pemohon->emel!='') ? $pemohon->emel : $pemohon->email }}</dd> --}}
                </div>
                <div class="form-group row">
                  <dt class="col-sm-2">No. Tel. Pejabat</dt>
                  <dd class="col-sm-4">{{ $personel->tel }}</dd>
                  {{-- <dd class="col-sm-4">{{ $pemohon->telefon ?? $pemohon->tel ?? $personel->tel }}</dd> --}}
                  <dt class="col-sm-2">No. Tel. Bimbit</dt>
                  <dd class="col-sm-4">{{ $personel->tel_bimbit }}</dd>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style ="color:{{$color}};">
                              <?php 
                                  $lengkapOrNot = \App\Tindakan::where('id_permohonan', $permohonanBilik->id_permohonan_bilik)
                                                              ->where('id_status_makan', '!=', null)
                                                              ->first();
                                  if(isset($lengkapOrNot)) {
                                    echo  $status;
                                  }
                                  else {
                                    echo '<font color="orange">Tidak Lengkap (Sila Kemaskini atau Batal)</font>';
                                  }
                                  // echo $draftOrNot->id_permohonan;
                              ?>
                          </td>
                          <td align="center">
