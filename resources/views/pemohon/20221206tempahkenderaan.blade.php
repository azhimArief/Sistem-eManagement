...
<script type="text/javascript">
	...
	function updatePenumpang() {
		...
		for(var mj=0; mj<splitMJ.length - 1; mj++) {
			...
			var emel = mAhli[6];
			var mykad = mAhli[7];
			newSenMJ = newSenMJ+'<tr><td>'+bil+'</td><td>'+nama+'</td><td>'+bahagian+'</td><td>'+no_tel+'</td><td>'+emel+'</td><td><button type="button" class="btn btn-sm btn-danger" id="btnRemovePenumpang'+mj+'" onclick="removePenumpang('+mj+');" title="Hapus"><i class="fa fa-trash"></i></button></td></tr>';
		}
		$('#senMJ').html(newSenMJ);
	}
