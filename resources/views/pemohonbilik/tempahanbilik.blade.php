...
@section('content')
    ...
    <div class="container" align="center">
        ...
        <div class="col-sm-11">
            <div class="card card-info">
                ...
                <form role="form" action="{{ route('pemohon.simpan_bilik', $result->nokp) }}" method="POST"
                    ...
                    <div class="card-header bg-purple">
                        ...
                        <a class="btn btn-sm bg-purple float-right" data-toggle="modal" data-target="#tatacaraModal" title="Lihat Tatacara">
                            <i class="fa fa-book"></i> Tatacara Permohonan
                        </a>
                    </div>
                    <p></p>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <input type="number" class="form-control" id="jumlah_pegawai" name="jumlah_pegawai"
                                        ...
                                        oninvalid="this.setCustomValidity('Kapasiti maksimum 60 orang sahaja')"
    ...
    <div class="modal fade " id="tatacaraModal" tabindex="-1" role="dialog" aria-labelledby="tatacaraModalLabel" aria-hidden="true">
...
@section('script')
    ...
    @if (session('tatacara'))
        <script>
            //bile error checking tatacara x muncul dah
