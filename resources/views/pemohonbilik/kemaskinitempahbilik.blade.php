    ...
    <div class="container" align="center">
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <button type="button" class="btn btn-light btn-block bg-purple">
                        <h5>KEMASKINI TEMPAHAN BILIK</h5>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-11">
            <div class="card card-info">
                ...
                <form role="form"
                    action="{{ route('pemohon.simpanK_tempahanbilik', $permohonanBiliks->id_permohonan_bilik, $cariPemohon->id_pemohon) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="bahagian" name="bahagian"
                                    ...
                                    {{-- value="{{ old('bahagian') == null ? $pemohon->bahagian_id : old('bahagian') }}" --}}
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-9">
                                <select class="form-control select2" id="nama_pengerusi" name="nama_pengerusi" style="width: 100%;"
                                    required>
                                    @php old('nama_pengerusi') == NULL ? $nama=$permohonanBiliks->nama_pengerusi : $nama=old('nama_pengerusi') @endphp
                                    <option value="" @if ($nama == '') {{ 'selected="selected"' }} @endif>&nbsp;</option>
                                    @foreach ($pengerusi as $pengerusiS)
                                         @if ($pengerusiS->agensi_id == 1 || $pengerusiS->agensi_id == 3)
                                            <option value="{{ $pengerusiS->id }}"
                                                @if ($nama == $pengerusiS->id) {{ 'selected="selected"' }} @endif>
